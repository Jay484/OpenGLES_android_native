...
import com.example.opengles_android_native.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    /**
     * A native method that is implemented by the 'opengles_android_native' native library,
